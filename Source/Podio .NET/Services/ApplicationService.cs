...
namespace PodioAPI.Services
{
    public class ApplicationService
    {
        ...
        /// </param>
        /// <returns></returns>
        public Application GetApp(long appId, string type = "full")
        {
        ...
        /// <returns></returns>
        public List<Application> GetAppsBySpace(long spaceId, bool includeInactive = false, Dictionary<string, string> additionalAttributes = null)
        {
            var requestData = new Dictionary<string, string>
            {
        ...
        /// <returns></returns>
        public List<string> GetFeatures(long[] appIds, bool includeSpace = false)
        {
        ...
        /// <returns></returns>
        public ApplicationField GetAppField(long appId, long fieldId)
        {
        ...
        /// <returns></returns>
        public List<long> GetIconSuggestions(string query)
        {
            ...
            return _podio.Get<List<long>>(url, requestData);
        }
        ...
        /// <returns></returns>
        public List<Application> GetTopAppsForOrganization(long organizationId)
        {
        ...
        /// <returns></returns>
        public ApplicationRevision DeleteAppField(long appId, long fieldId, bool deleteValues = false)
        {
            string url = string.Format("/app/{0}/field/{1}", appId, fieldId);
        ...
        /// </param>
        /// <returns></returns>
        public List<Application> GetAllUserApps(long[] excludeAppIds = null, long? referenceableInOrg = null,
        ...
        /// </param>
        /// <returns></returns>
        public Application GetAppOnSpaceByURLLabel(long spaceId, string UrlLabel, string type = "full")
        {
        ...
        /// <returns></returns>
        public ApplicationField GetAppField(long appId, string externalId)
        {
        ...
        public void UpdateAppOrder(long spaceId, List<long> appIds)
        {
        ...
        public void UpdateAppDescription(long appId, string description)
        {
        ...
        public void UpdateAppUsageInstructions(long appId, string usage)
        {
        ...
        /// </param>
        /// <returns></returns>
        public long InstallApp(long appId, long spaceId, string[] features = null)
        {
        ...
        /// <param name="appId"></param>
        /// <returns></returns>
        public List<AppCalculation> GetCalculationsForApp(long appId)
        {
        ...
        public long AddNewApp(Application application)
        {
            /*
        ...
        public long AddNewAppField(long appId, ApplicationField field)
        {
            /*
        ...
        public void UpdateAnAppField(long appId, long fieldId, FieldConfig config)
        {
            string url = string.Format("/app/{0}/field/{1}", appId, fieldId);
        ...
        /// <param name="appId"></param>
        /// <returns></returns>
        public ApplicationDependency GetAppDependencies(long appId)
        {
        ...
        /// <param name="spaceId"></param>
        /// <returns></returns>
        public ApplicationDependency GetSpaceAppDependencies(long spaceId)
        {
