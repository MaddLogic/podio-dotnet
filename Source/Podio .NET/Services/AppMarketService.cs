...
namespace PodioAPI.Services
{
    public class AppMarketService
    {
        ...
        /// </param>
        /// <returns></returns>
        public async Task<AppMarketShares> GetSharesByAuthor(string type, long userId, int limit = 6, int offset = 0,
            string sort = "install")
        {
        ...
        /// </param>
        /// <returns></returns>
        public async Task<AppMarketShares> GetSharesByCategory(string type, long categoryId, int limit = 6, int offset = 0,
            string sort = "install")
        {
