...
namespace PodioAPI.Services
{
    public class ItemService
    {
        ...
        public long AddNewItem(long appId, Item item, long? spaceId = null, bool silent = false, bool hook = true)
        {
        ...
        public long? UpdateItem(Item item, long? spaceId = null, long? revision = null, bool silent = false, bool hook = true)
        {
            JArray fieldValues =
                JArray.FromObject(
        ...
        public Item GetItemByAppItemId(long appId, long appItemId)
        {
        ...
        /// <returns></returns>
        public Item GetItemByExternalId(long appId, string external_id)
        {
        ...
        public PodioCollection<Item> FilterItems(long appId, FilterOptions filterOptions, bool includeFiles = false)
        {
        ...
        /// <returns></returns>
        public PodioCollection<Item> FilterItems(long appId, int? limit = 30, int? offset = 0, Object filters = null,
        ...
        /// <returns></returns>
        public FileResponse GetItemsAsXlsx(long appId, Dictionary<string, string> filters, int limit = 20, int offset = 0,
        ...
        /// </param>
        /// <returns>Collection of matching items</returns>
        public BulkDeletionStatus BulkDeleteItems(long appId, BulkDeleteRequest deleteRequest, bool silent = false)
        {
        ...
        public long CloneItem(long itemId, bool silent = false)
        {
        ...
        public long ExportItems(long appId, string exporter, ExportFilter filter)
        {
        ...
        /// <returns>The id of the batch created for this export</returns>
        public long ExportItems(long appId, string exporter, int? limit = null, int? offset = null, long? viewId = null,
        ...
        /// <param name="includeFiles">True to include files when getting filtered items, defaults to false</param>
        /// <returns></returns>
        public PodioCollection<Item> FilterItemsByView(long appId, long viewId, int limit = 30, int offset = 0,
        ...
        /// <returns></returns>
        public List<Item> GetTopValuesByField(long fieldId, int limit = 13, long[] notItemIds = null)
        {
        ...
        /// <param name="appId"></param>
        /// <returns></returns>
        public AppValues GetAppValues(long appId)
        {
        ...
        /// <param name="fieldId"></param>
        /// <returns></returns>
        public T GetItemFieldValues<T>(long itemId, long fieldId) where T : new()
        {
        ...
        /// <param name="appId"></param>
        /// <returns></returns>
        public long GetItemCount(long appId)
        {
        ...
        /// <param name="fieldId"></param>
        /// <returns></returns>
        public Range GetFieldRanges(long fieldId)
        {
        ...
        /// <param name="itemId"></param>
        /// <returns></returns>
        public ItemRevision GetItemRevision(long itemId, long revision)
        {
        ...
        /// <returns></returns>
        public List<ItemMicro> GetReferencesToItemByField(long itemId, long fieldId, int limit = 20)
        {
            var requestData = new Dictionary<string, string>
            {
                {"limit", limit.ToString()}
        ...
        public void UpdateItemReference(long itemId, string type, long referenceId)
        {
            dynamic requestData = new
            {
                type = type,
        ...
        public long? RevertItemRevision(long itemId, long revisionId)
        {
        ...
        /// <param name="revisionId"></param>
        /// <returns>The id of the new revision</returns>
        public long? RevertToRevision(long itemId, long revisionId)
        {
        ...
        /// <returns></returns>
        public List<Item> FindReferenceableItems(long fieldId, int limit = 13, long[] notItemIds = null,
        ...
        /// <returns></returns>
        public List<ItemDiff> GetItemRevisionDifference(long itemId, long revisionFrom, long revisionTo)
        {
