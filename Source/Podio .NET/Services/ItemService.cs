...
namespace PodioAPI.Services
{
    public class ItemService
    {
        ...
        /// <param name="includeFiles">True to include files when getting filtered items, defaults to false</param>
        /// <returns></returns>
        public async Task<PodioCollection<Item>> FilterItemsByView(long appId, long viewId, int limit = 30, int offset = 0,
        ...
        /// <returns></returns>
        public async Task<List<Item>> GetTopValuesByField(long fieldId, int limit = 13, long[] notItemIds = null)
        {
        ...
        /// <param name="fieldId"></param>
        /// <returns></returns>
        public async Task<Range> GetFieldRanges(long fieldId)
        {
        ...
        /// <returns></returns>
        public async Task<List<ItemMicro>> GetReferencesToItemByField(long itemId, long fieldId, int limit = 20)
        {
            var requestData = new Dictionary<string, string>()
            {
                {"limit", limit.ToString()}
        ...
        /// <returns></returns>
        public async Task<List<Item>> FindReferenceableItems(long fieldId, int limit = 13, long[] notItemIds = null,
