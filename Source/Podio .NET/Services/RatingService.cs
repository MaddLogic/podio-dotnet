...
namespace PodioAPI.Services
{
    public class RatingService
    {
        ...
        public async Task<long> AddRating(string refType, long refId, string ratingType, int value)
        {
        ...
        /// <returns></returns>
        public async Task<int> GetRating(string refType, long refId, string ratingType, long userId)
        {
