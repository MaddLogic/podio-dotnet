...
namespace PodioAPI.Services
{
    public class StreamService
    {
        ...
        /// <param name="offset">How far should the objects be offset</param>
        /// <returns></returns>
        public IEnumerable<StreamObject> GetAppStream(long appId, int? limit = null, int? offset = null)
        {
        ...
        /// <param name="offset">How far should the objects be offset </param>
        /// <returns></returns>
        public IEnumerable<StreamObject> GetSpaceStream(long spaceId, int? limit = null, int? offset = null)
        {
        ...
        /// <param name="offset">How far should the objects be offset </param>
        /// <returns></returns>
        public IEnumerable<StreamObject> GetUserStream(long userId, int? limit = null, int? offset = null)
        {
        ...
        /// <param name="offset">How far should the objects be offset </param>
        /// <returns></returns>
        public IEnumerable<StreamObject> GetOrganizationStream(long orgId, int? limit = null, int? offset = null)
        {
        ...
        /// <returns></returns>
        public StreamObject GetStreamObject(string refType, long refId)
        {
        ...
        /// <param name="offset">Index of first returned group. Default value: 0</param>
        /// <returns></returns>
        public List<StreamObjectV3> GetApplicationStreamV3(long appId, string[] groupsEventTypes = null,
        ...
        /// >
        /// <returns></returns>
        public List<StreamObjectV3> GetOrgStreamV3(long orgId, string[] groupsEventTypes = null, int groupsLimit = 2,
            int limit = 10, int offset = 0)
        {
        ...
        /// <param name="groupsLimit">Default value: 2</param>
        /// <returns></returns>
        public List<StreamObjectV3> GetSpaceStreamV3(long spaceId, string[] groupsEventTypes = null, int groupsLimit = 2)
        {
        ...
        /// >
        /// <returns></returns>
        public List<StreamObjectV3> GetUserStreamV3(long userId, string[] groupsEventTypes = null, int groupsLimit = 2,
            int limit = 10, int offset = 0)
        {
        ...
        /// <param name="groupsLimit">Default value: 2</param>
        /// <returns></returns>
        public List<StreamObjectV3> GetStreamObjectV3(string refType, long refId, string[] groupsEventTypes = null,
            int groupsLimit = 2)
        {
