...
namespace PodioAPI.Services
{
    public class TagService
    {
        ...
        /// <returns></returns>
        public async Task<List<TaggedObject>> GetObjectsOnAppWithTag(long appId, string text)
        {
        ...
        /// <returns></returns>
        public async Task<List<TaggedObject>> GetObjectsOnOrganizationWithTag(long orgId, string text)
        {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public async Task<List<TaggedObject>> GetObjectsOnSpaceWithTag(long spaceId, string text)
        {
        ...
        /// <param name="text">The tag to search for.</param>
        /// <returns></returns>
        public async Task<List<Tag>> GetTagsOnApp(long appId, int? limit = null, string text = null)
        {
        ...
        /// <param name="text">The tag to search for</param>
        /// <returns></returns>
        public async Task<List<string>> GetTagsOnAppTop(long appId, int? limit = null, string text = null)
        {
        ...
        /// <param name="text">The tag to search for</param>
        /// <returns></returns>
        public async Task<List<Tag>> GetTagsOnOrganization(long orgId, int? limit = null, string text = null)
        {
        ...
        /// <param name="text">The tag to search for</param>
        /// <returns></returns>
        public async Task<List<Tag>> GetTagsOnSpace(long spaceId, int? limit = null, string text = null)
        {
