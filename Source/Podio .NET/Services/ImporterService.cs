...
namespace PodioAPI.Services
{
    public class ImporterService
    {
        ...
        /// <returns></returns>
        public async Task<int> ImportAppItems(long fileId, long appId, List<ImportMappingField> mappings, string tagsColumnId = null,
        ...
        /// <returns></returns>
        public async Task<int> ImportSpaceContacts(long fileId, long spaceId, List<ImportMappingContactField> mappings)
        {
