...
namespace PodioAPI.Services
{
    public class FlowService
    {
        ...
        /// <returns></returns>
        public List<Flow> GetFlows(string refType, long refId)
        {
        ...
        /// <param name="flowId"></param>
        /// <returns></returns>
        public Dictionary<string, FlowAttribute> GetFlowContext(long flowId)
        {
        ...
        public long AddNewFlow(string refType, long refId, string name, string type, List<Effect> effects,
            dynamic config = null)
        {
            string url = string.Format("/flow/{0}/{1}/", refType, refId);
        ...
        /// <param name="effects">The list of effects to add</param>
        /// <param name="config">The configuration for the cause of the flow</param>
        public void UpdateFlow(long flowId, string name, List<Effect> effects = null, dynamic config = null)
        {
            string url = string.Format("/flow/{0}", flowId);
            dynamic requestData = new
            {
        ...
        /// <returns></returns>
        public List<FlowAttribute> GetPossibleAttributes(string refType, long refId, Cause cause, dynamic effect)
        {
